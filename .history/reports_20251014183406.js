...
function applyTheme(dark) {
  ...
  // Do NOT set switchMode.checked here (per your request)
}
...
document.querySelectorAll('#sidebar .side-menu.top li a').forEach(a => {
  a.addEventListener('click', (e) => {
    ...
    // prevent reload if clicking the current page link (avoids flash)
    if (same) {
      e.preventDefault();
      return;
    }
    ...
    // lock background to correct theme before navigating
    paintLock();

...
document.addEventListener("DOMContentLoaded", () => {
    ...
    <script>
// === Profile Dropdown & Logout Function ===

// Create dropdown element dynamically (to avoid changing UI structure)
...
profileDropdown.innerHTML = `
    <ul class="dropdown-menu">
        ...
        <li id="logoutBtn"><i class='bx bxs-log-out'></i> Logout</li>
    </ul>
`;
document.body.appendChild(profileDropdown);

// Basic styling (won’t affect your existing UI)
...
profileImg.addEventListener("click", (e) => {
    ...
    profileDropdown.style.right = `${window.innerWidth - rect.right - 20}px`;

...
// Dark Mode (no-flash, uses your existing 'dark-mode' key)
const switchMode = document.getElementById('switch-mode');

// Check stored preference on page load (html + body to avoid flash)
...
switchMode.addEventListener('change', function () {
    ...
    // remove transition-kill class on next frame
